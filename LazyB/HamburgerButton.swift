...
public class HamburgerButton: UIButton {
    ...
    private func commonInit() {
        ...
        for shapeLayer in shapeLayers {
            ...
            // let strokingPath = CGPathCreateCopyByStrokingPath(shapeLayer.path, &transform, shapeLayer.lineWidth, CGLineCap.butt, CGLineJoin.miter, shapeLayer.miterLimit)
            let strokingPath = shapeLayer.path?.copy(strokingWithWidth: shapeLayer.lineWidth, lineCap: CGLineCap.butt, lineJoin: CGLineJoin.miter, miterLimit: shapeLayer.miterLimit, transform: CGAffineTransform.identity)
